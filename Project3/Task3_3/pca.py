...
if __name__ == "__main__":
    ...
    plt.scatter(X_trans[0, y == 1], X_trans[1, y == 1], c='blue', label='Class 1', alpha=0.75)
    plt.scatter(X_trans[0, y == 2], X_trans[1, y == 2], c='red', label='Class 2', alpha=0.75)
    ...
    ax.scatter(X_trans[0, y == 1], X_trans[1, y == 1], X_trans[2, y == 1], c='blue', label='Class 1', alpha=0.75)
    ax.scatter(X_trans[0, y == 2], X_trans[1, y == 2], X_trans[2, y == 2], c='red', label='Class 2', alpha=0.75)
